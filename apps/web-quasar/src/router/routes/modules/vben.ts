...
import {
  ...
  VBEN_QUASAR_PREVIEW_URL,
  VBEN_VUETIFY_PREVIEW_URL,
} from '@vben/constants';
import { SvgArcoLogoIcon, SvgQuasarLogoIcon } from '@vben/icons';
...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        name: 'VbenQuasar',
        path: '/vben-admin/quasar',
        component: IFrameView,
        meta: {
          badgeType: 'dot',
          icon: SvgQuasarLogoIcon,
          link: VBEN_QUASAR_PREVIEW_URL,
          title: $t('demos.vben.quasar'),
        },
      },
    ],
  },
